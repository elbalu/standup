...
var input_path = "./public/templates"; // directory of dust templates are stored with .dust file extension
var output_path = "./public/js/jsdust/"; // directory where the compiled .js files should be saved to
